...
|---|---|---|---|---|
| `E43` | `regi` | sujet | chaque | dénutrition sévère |
| `E44.0` | `regi` | sujet | chaque | dénutrition modérée |
...
| code_expr | role | centralite | portee | condition |
|---|---|---|---|---|
| `E43` | `regi` | sujet | chaque |  |
| `E44.0` | `regi` | sujet | chaque |  |
...
| code_expr | role | centralite | portee | condition |
|---|---|---|---|---|
| `E43` | `regi` | sujet | chaque | le sévère prime |
| `E44.0` | `interdit` | sujet | chaque | écarté au profit de E43 |
...
|---|---|---|---|---|
| `E40-E46` | `regi` | sujet | chaque |  |
| `O25` | `regi` | sujet | chaque | pendant la grossesse |
...
| code_expr | role | centralite | portee | condition |
|---|---|---|---|---|
| `E43` | `regi` | sujet | chaque | critère phénotypique attestant la dénutrition |
| `E44.0` | `regi` | sujet | chaque | critère phénotypique attestant la dénutrition |
