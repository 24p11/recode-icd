...
| code_expr | role | centralite | condition |
|---|---|---|---|
| `R78` | `regi` | sujet | si présence confirmée |
| `Z04.0` | `regi` | sujet |  |
...
| `Z04.880` | `regi` | sujet | autres investigations |
...
|---|---|---|---|
| `Z29.0` | `regi` | sujet |  |
| `Z60` | `regi` | sujet | isolement social |
...
| `Z29` | `regi` | sujet | seule à justifier un DR |
...
| code_expr | role | centralite | condition |
|---|---|---|---|
| `Z34` | `regi` | sujet | grossesse normale |
| `Z35.–` | `regi` | sujet | toute grossesse non normale |
...
| code_expr | role | centralite | condition |
|---|---|---|---|
| `Z43.–` | `interdit_DAS` | sujet | acte CCAM présent |
| `Z45.–` | `interdit_DAS` | sujet | acte CCAM présent |
...
| code_expr | role | centralite | condition |
|---|---|---|---|
| `Z51.00` | `regi` | sujet | exception |
| `Z51.01` | `DAS` | sujet | exception : irradiation au cours d'un autre séjour |
| `Z51.–` | `interdit_DAS` | sujet | acte CCAM présent |
...
|---|---|---|---|
| `Z53` | `regi` | sujet |  |
| `Z53.1` | `regi` | **exemple** | refus pour motif de conviction |
| `Z53.2` | `regi` | **exemple** | sortie contre avis médical |
...
| code_expr | role | centralite | condition |
|---|---|---|---|
| `T86.2` | `regi` | **exemple** | un rejet se code T86.2 |
| `Z94` | `DP` | sujet |  |
...
| code_expr | role | centralite | condition |
|---|---|---|---|
| `Z93.–` | `interdit_DAS` | sujet | acte CCAM présent |
| `Z95.–` | `interdit_DAS` | sujet | acte CCAM présent |
| `Z96.–` | `interdit_DAS` | sujet | acte CCAM présent |
...
| `Z99.1` | `interdit` | **exemple** | ventilation en insuffisance respiratoire aigüe |
