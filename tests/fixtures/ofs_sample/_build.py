...
def main() -> None:
    ...
    master = [
        _row(
            "SID", "code", "sort", "abbrev", "level", "type",
            "id1", "id2", "id3", "id4", "id5", "id6", "id7",
            "valid", "date", "author", "comment",
        ),
        # Chapter I (Certaines maladies infectieuses)
        _row(1, "(A00-B99)", "A00'", "(A00-B99)", 1, "C",
             1, 0, 0, 0, 0, 0, 0, 1, _DATE, _AUTHOR, _COMMENT),
        # Block A00-A09
        _row(2, "(A00-A09)", "A00-", "(A00-A09)", 2, "G",
             1, 2, 0, 0, 0, 0, 0, 1, _DATE, _AUTHOR, _COMMENT),
        # A00 (choléra) — inclusion
        _row(3, "A00", "A00,", "A00", 3, "K",
             1, 2, 3, 0, 0, 0, 0, 1, _DATE, _AUTHOR, _COMMENT),
        _row(4, "A00.0", "A00.0", "A000", 4, "S",
             1, 2, 3, 4, 0, 0, 0, 1, _DATE, _AUTHOR, _COMMENT),
        # A01 — exclusion redirect → A02
        _row(5, "A01", "A01,", "A01", 3, "K",
             1, 2, 5, 0, 0, 0, 0, 1, _DATE, _AUTHOR, _COMMENT),
        # A02 (target of A01 redirect)
        _row(6, "A02", "A02,", "A02", 3, "K",
             1, 2, 6, 0, 0, 0, 0, 1, _DATE, _AUTHOR, _COMMENT),
        # A03 — synonyme + note éditoriale
        _row(7, "A03", "A03,", "A03", 3, "K",
             1, 2, 7, 0, 0, 0, 0, 1, _DATE, _AUTHOR, _COMMENT),
        # A99 — invalide (test filtre valid=0)
        _row(8, "A99", "A99,", "A99", 3, "K",
             1, 2, 8, 0, 0, 0, 0, 0, _DATE, _AUTHOR, _COMMENT),
        # Chapter IX (I00-I99)
        _row(9, "(I00-I99)", "I00'", "(I00-I99)", 1, "C",
             9, 0, 0, 0, 0, 0, 0, 1, _DATE, _AUTHOR, _COMMENT),
        # Block I40-I49
        _row(10, "(I40-I49)", "I40-", "(I40-I49)", 2, "G",
             9, 10, 0, 0, 0, 0, 0, 1, _DATE, _AUTHOR, _COMMENT),
        # I41 — astérisque dans la paire DAGSTAR
        _row(11, "I41", "I41,", "I41", 3, "K",
             9, 10, 11, 0, 0, 0, 0, 1, _DATE, _AUTHOR, _COMMENT),
        # Chapter X (J00-J99)
        _row(12, "(J00-J99)", "J00'", "(J00-J99)", 1, "C",
             12, 0, 0, 0, 0, 0, 0, 1, _DATE, _AUTHOR, _COMMENT),
        # Block J10-J18
        _row(13, "(J10-J18)", "J10-", "(J10-J18)", 2, "G",
             12, 13, 0, 0, 0, 0, 0, 1, _DATE, _AUTHOR, _COMMENT),
        # J11 — dague dans la paire DAGSTAR
        _row(14, "J11", "J11,", "J11", 3, "K",
             12, 13, 14, 0, 0, 0, 0, 1, _DATE, _AUTHOR, _COMMENT),
    ]
    ...
    libelle = [
        _row(
            "LID", "SID", "source", "valid", "libelle",
            "FR_OMS", "EN_OMS", "GE_DIMDI", "GE_AUTO", "FR_CHRONOS",
            "date", "author", "comment",
        ),
    ]
    for lid, sid, source, text in libelles_data:
        libelle.append(_row(
            lid, sid, source, 1, text,
            text, "", "", "", "",
            _DATE, _AUTHOR, _COMMENT,
        ))
    ...
    memo = [
        _row(
            "'MID'", "'SID'", "'source'", "'valid'", "'memo'",
            "'FR_OMS'", "'EN_OMS'", "'GE_DIMDI'", "'date'", "'author'", "'comment'",
        ),
        _row(
            1, 7, "'N'", "'Yes'",
    ...
    version = [
        ...
        _row(
            "ICD10 OFS test", "V0", "001", 1,
            "14.7.2003 00:00:00", "fixture de test recode-icd",
        ),
    ]
